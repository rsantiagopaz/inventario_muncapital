qx.Class.define("inventario.comp.rpc.Rpc",
{
	...
	construct : function (url, serviceName)
	{
		...
		if (inventario.comp.rpc.Rpc.LOADING == null) {
			this.loading = new componente.comp.ui.ramon.image.Loading("inventario/loading66.gif");
		} else {
			this.loading = inventario.comp.rpc.Rpc.LOADING;
		}
